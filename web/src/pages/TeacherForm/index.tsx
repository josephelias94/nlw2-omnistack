...
function Form() {
  ...
  function handleCreateClass(e: FormEvent) {
    ...
    api
      ...
      .then(() => {
        alert('Cadastro realizado sucesso!');
        history.push('/');
      })
      .catch(() => alert('Não foi possivel realizar esta operação'));
  }
...
function TeacherForm() {
  return (
    <div id="page-teacher-form" className="container">
      <PurpleHeader title="Que incrível que você quer dar aulas." description="O primeiro passo, é preencher esse formulário de inscrição." />
      <Form />
    </div>
  );
}
